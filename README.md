...
Passive sniffer wiring is documented in the harness/wiring notes, and prototype
pin-needle tap photos are included in [`docs/10-boot-sniffer.md`](docs/10-boot-sniffer.md).
